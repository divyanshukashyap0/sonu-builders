    ...
    const renderTestimonials = () => (
        <div className="space-y-6 animate-fadeIn">
            <div className="flex justify-between items-center">
                <h3 className="text-xl font-bold text-luxury-charcoal dark:text-white">Testimonials</h3>
                <button className="bg-luxury-gold text-white px-4 py-2 rounded-lg flex items-center gap-2 hover:bg-luxury-gold/90">
                    <Plus size={18} /> Add New
                </button>
            </div>
            <div className="space-y-4">
                {testimonials.map((t) => (
                    <div key={t.id} className="bg-white dark:bg-neutral-800 p-4 rounded-xl shadow-sm border border-luxury-gold/10 flex justify-between items-center">
                        <div>
                            <p className="font-bold text-luxury-charcoal dark:text-white">{t.name}</p>
                            <p className="text-sm text-gray-500 dark:text-gray-400">"{t.text}"</p>
                            <div className="flex text-yellow-500 mt-1">
                                {[...Array(t.rating)].map((_, i) => <Star key={i} size={12} fill="currentColor" />)}
                            </div>
                        </div>
                        <div className="flex gap-2">
                            <button className="p-2 hover:bg-gray-100 dark:hover:bg-white/5 rounded-full text-blue-500"><Edit size={18} /></button>
                            <button className="p-2 hover:bg-gray-100 dark:hover:bg-white/5 rounded-full text-red-500"><Trash2 size={18} /></button>
                        </div>
                    </div>
                ))}
            </div>
            ...
            {!activeView ? (
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    >
                        ...
                        <h3 className="text-xl font-serif text-white mb-2">Home Hero</h3>
                        <p className="text-sm text-neutral-400">Manage the main landing section, headlines, and background visuals.</p>
                    </div>
                    ...
                    >
                        ...
                        <h3 className="text-xl font-serif text-white mb-2">Philosophy</h3>
                        <p className="text-sm text-neutral-400">Edit the 'Defining Modern Luxury' section content and imagery.</p>
                    </div>
                    ...
                    >
                        ...
                        <h3 className="text-xl font-serif text-white mb-2">Lead Form</h3>
                        <p className="text-sm text-neutral-400">Customize the contact form background and policy text.</p>
                    </div>
                    ...
                    >
                        ...
                        <h3 className="text-xl font-serif text-white mb-2">Why Choose Us</h3>
                        <p className="text-sm text-neutral-400">Edit the 'Excellence in Every Detail' section.</p>
                    </div>
                    ...
                    >
                        <div className="absolute inset-0 bg-gradient-to-br from-luxury-gold/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity" />
                        <BarChart3 className="w-8 h-8 text-neutral-500 mb-4" />
                        <h3 className="text-xl font-serif text-white mb-2">Trust Metrics</h3>
                        <p className="text-sm text-neutral-400">Edit statistics and achievement numbers.</p>
                    </div>
                    ...
                    >
                        <div className="absolute inset-0 bg-gradient-to-br from-luxury-gold/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity" />
                        <ImageIcon className="w-8 h-8 text-neutral-500 mb-4" />
                        <h3 className="text-xl font-serif text-white mb-2">Gallery Header</h3>
                        <p className="text-sm text-neutral-400">Edit the gallery page intro text.</p>
                    </div>
